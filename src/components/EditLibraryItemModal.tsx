// src/components/EditLibraryItemModal.tsx - RENAMED FROM EditCollectionItemModal
...
export function EditLibraryItemModal({ 
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      console.error('[EditLibraryItem] Update error:', err);
      ...
      <div className="bg-white rounded-xl shadow-xl max-w-2xl w-full max-h-[90vh] overflow-hidden">
        ...
        <div className="flex items-center justify-between p-6 border-b border-slate-200">
          <div className="flex items-center space-x-3">
            ...
            <h2 className="text-xl font-semibold text-slate-900">Edit Library Item</h2>
          </div>
          <button
            onClick={handleClose}
          ...
          {updateSuccess && (
            <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-4">
              <div className="flex items-center">
                ...
                <span className="text-green-800 font-medium">Library item updated successfully!</span>
              </div>
            </div>
          )}
